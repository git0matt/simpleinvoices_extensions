...
class st_export
{
    ...
    public function __construct() {
        ...
        $this->customer              = null;
        $this->customer_id           = 0;
		$this->ship_to_customer              = null;/**/
		$this->ship_to_customer_id           = 0;/**/
    ...
    public function getData() {
        ...
        switch ($this->module) {
            case "statement":
                ...
                if (!empty($this->biller_id))
					$pdoDb->addSimpleWhere("biller_id", $this->biller_id, "AND");
                if (!empty($this->customer_id))
					$pdoDb->addSimpleWhere("customer_id", $this->customer_id, "AND");
				if (!empty($this->ship_to_customer_id))
					$pdoDb->addSimpleWhere("ship_to_customer_id", $this->ship_to_customer_id, "AND");/**/
				...
				//if (!empty($this->ship_to_customer_id))/**/
				//	$ship_to_customer_details = Customer::get($this->ship_to_customer_id);/**/
                if (empty($this->file_name)) {
					...
					//if (!empty($this->ship_to_customer_id)) $pdf_file_name .= '_' . $this->ship_to_customer_id;/**/
				...
				//$smarty->assign('ship_to_customer_id'          , $this->ship_to_customer_id);/**/
                $smarty->assign('customer_details'     , $customer_details);
				//$smarty->assign('ship_to_customer_details'     , $ship_to_customer_details);/**/
            ...
            case "payment":
				...
				//$ship_to_customer          = Customer::get($payment['ship_to_customer_id']);/**/
            ...
            case "invoice":
				...
				if (!isset($this->ship_to_customer))/**/
					$this->ship_to_customer = Customer::get($this->invoice['ship_to_customer_id']);/**/
                if (!isset($this->biller))
				...
				$smarty->assign('ship_to_customer', $this->ship_to_customer);/**/

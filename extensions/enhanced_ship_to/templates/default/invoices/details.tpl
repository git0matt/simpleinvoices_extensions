                ...
                <td>
                    ...
                    {else}
                        <select name="ship_to_customer_id">
                            {foreach from=$customers item=ship_to_customer}
                                <option {if $ship_to_customer.id == $invoice.ship_to_customer_id} selected {/if}
                                        value="{$ship_to_customer.id|htmlsafe}">{$ship_to_customer.name|htmlsafe}</option>
                            {/foreach}
                        </select>
                    {/if}
                </td>

...
{*if file_exists('../invoices/quick_view_invoice_view.tpl'){include file="../invoices/quick_view_invoice_view.tpl"}{else}{include file="$path/quick_view_invoice_view.tpl"}{/if*}

<?php
		...
		if ($_POST['action'] == "insert" ) {
			$list = array('biller_id' =>       $_POST['biller_id'],
						  ...
						  'ship_to_customer_id' => $_POST['ship_to_customer_id'],//added for ship_to 20170802//
						  'type_id' =>         $type,
...
/**********
 Script: ./extensions/ship_to/modules/save.php
 Replacement for saving an invoice
 
 Last edited:
 2018-11-22	git0matt@gmail.com
 **********/

...
$('#manageGrid').flexigrid ( {
    ...
    colModel : [
        ...
        {display: '{/literal}{$LANG.role}{literal}', 		name: 'role_name', 	width:  8 * percentage_width, sortable: true, 	align: 'left'},
        {display: '{/literal}{$LANG.enabled}{literal}', 	name: 'enabled', 	width:  6 * percentage_width, sortable: true, 	align: 'center'},
        {display: '{/literal}{$LANG.user_id}{literal}', 	name: 'uid', 		width: 18 * percentage_width, sortable: true, 	align: 'left'}
    ],
    searchitems : [

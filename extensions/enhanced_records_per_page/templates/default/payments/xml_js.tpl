{* modules/payments/manage.js.php *}
<script>
{literal}
    var columns      = 9;
    var padding      = 12;
    ...
    $("#manageGrid").flexigrid ({
        ...
        useRp:     {/literal}{if isset($defaults.show_rp)}true{elseif isset($defaults.default_rp_payments) && $defaults.default_rp_payments > 0}true{else}false{/if}{literal},
		rp:        {/literal}{if isset($smarty.get.rp)}{$smarty.get.rp}{elseif isset($defaults.default_rp) && $defaults.show_rp == $LANG.enabled}{$defaults.default_rp}{elseif isset($defaults.default_rp_payments) && $defaults.default_rp_payments > 0}{$defaults.default_rp_payments}{else}20{/if}{literal},
        showToggleBtn:      false,
